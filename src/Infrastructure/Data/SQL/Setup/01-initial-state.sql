...
(
    ...
    date_created     timestamp without time zone NOT NULL,
    date_updated     timestamp without time zone NOT NULL,
    public_id        integer                     NOT NULL GENERATED BY DEFAULT AS IDENTITY,
    content          text                        NOT NULL,
    owner_id         integer                     NOT NULL,
    date_post_edited timestamp without time zone NOT NULL,
    CONSTRAINT pk_post_id PRIMARY KEY (id),
    CONSTRAINT fk_post_id FOREIGN KEY (owner_id) REFERENCES profiles (id) ON DELETE CASCADE
);
...
ALTER TABLE profiles
    ADD CONSTRAINT fk_profile_image_id FOREIGN KEY (username) REFERENCES post_images (id);
...
CREATE INDEX ix_post_images_owner_id ON post_images (owner_id);
